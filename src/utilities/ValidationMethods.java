...
public class ValidationMethods {
    ...
    public static void validateURL(WebDriver driver, String expectedURL){
        if (driver.getCurrentUrl().equals(expectedURL)) System.out.println("URL is VALIDATED");
                ...
                "Expected title: \"" + expectedURL + "\" | Actual Title: \"" + driver.getCurrentUrl() + "\"");
    }
    ...
    // *** import static utilities.ValidationUtils.*; ---> THIS IS HOW TO IMPORT ALL THE STATIC METHODS OF ANOTHER CLASS W/O HAVING IT INVOKE THE CLASSNAME EACH TIME
